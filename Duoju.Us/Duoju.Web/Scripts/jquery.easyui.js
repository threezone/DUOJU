...
var _6e=_6d.options;
var bb=_6d.bb={};
var _6f={first:{iconCls:"pagination-first icon-step-backward",handler:function(){
if(_6e.pageNumber>1){
_76(_6c,1);
}
}},prev:{iconCls:"pagination-prev  icon-backward",handler:function(){
if(_6e.pageNumber>1){
_76(_6c,_6e.pageNumber-1);
}
}},next:{iconCls:"pagination-next icon-forward",handler:function(){
var _70=Math.ceil(_6e.total/_6e.pageSize);
if(_6e.pageNumber<_70){
_76(_6c,_6e.pageNumber+1);
}
}},last:{iconCls:"pagination-last icon-step-forward",handler:function(){
var _71=Math.ceil(_6e.total/_6e.pageSize);
if(_6e.pageNumber<_71){
_76(_6c,_71);
}
}},refresh:{iconCls:"pagination-load icon-refresh",handler:function(){
...
bb.refresh.linkbutton({iconCls:"pagination-load  icon-refresh"});
}
}
};
...
//$("<div class=\"datagrid-header-check checker\"></div>").html("<span><input type=\"checkbox\" style=\"opacity: 0;\"></span></div>").appendTo(td);
